    ...
    def run(self):
        for source in self.osi_files:
            ...
            subprocess.check_call([self.find_protoc(),
                                   '--proto_path=.', '--python_out=' + package_path, './' + source])
...
setup(name='open-simulation-interface',
      ...
      author='Carlo van Driesten, Timo Hanke, Nils Hirsenkorn, Pilar Garcia-Ramos, Mark Schiementz, Sebastian Schneider',
      author_email='Carlo.van-Driesten@bmw.de, Timo.Hanke@bmw.de, Nils.Hirsenkorn@tum.de, Pilar.Garcia-Ramos@bmw.de, Mark.Schiementz@bmw.de, Sebastian.SB.Schneider@bmw.de',
